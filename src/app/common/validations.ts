...
export const OptionaTextValidation = [Validators.minLength(2), Validators.maxLength(50)]

export const RequiredTextVaidation = OptionaTextValidation.concat([Validators.required])
